...
final class XPCHelperClient: NSObject {
    ...
    private let serviceName = "com.kairo.app.KairoHelper"
    
    private var remoteService: RemoteXPCService<KairoXPCHelperProtocol>?
    ...
    @MainActor
    private func ensureRemoteService() -> RemoteXPCService<KairoXPCHelperProtocol> {
        ...
        let service = RemoteXPCService<KairoXPCHelperProtocol>(
            connection: conn,
            remoteInterface: KairoXPCHelperProtocol.self
        )
    ...
    @MainActor
    private func getRemoteService() -> RemoteXPCService<KairoXPCHelperProtocol>? {
        remoteService
    }
