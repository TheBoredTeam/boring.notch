...
- This subtree owns the mediaremote-adapter area for `mediaremote-adapter`.
- Keep this file current when responsibilities, contracts, or child docs change.

## Ownership

- Applies to every file under `mediaremote-adapter` unless a deeper AGENTS.md overrides it.
