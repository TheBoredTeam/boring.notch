...
//  IslandNotch
//
//  Purpose: Identifies how a screenshot entered the store. Drives the
//           per-source auto-copy policy (e.g. double-⌘ auto-copies, drag does not).
//  Layer: Model

import Foundation

/// Where a screenshot came from. Persisted in index.json and used to decide
/// whether the pasteable payload should be auto-copied to the clipboard.
enum CaptureSource: String, Codable, CaseIterable, Hashable, Identifiable {
