...
- This subtree owns the Configuration area for `Configuration`.
- Keep this file current when responsibilities, contracts, or child docs change.

## Ownership

- Applies to every file under `Configuration` unless a deeper AGENTS.md overrides it.
- Parent instructions from the repository root remain binding.

## Local Contracts

- Keep this doc focused on durable contracts for this subtree.
- DMG packaging defaults target the minitap product name and `minitap.app`.
