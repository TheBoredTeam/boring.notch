...
- Turn on **Settings › System Monitor** to add a *System* tab with live CPU, memory, battery health, disk, network and Wi-Fi readings.
...
- [x] System monitor (CPU, memory, battery health, disk, network, Wi-Fi) 📊
