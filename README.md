...
- Turn on **Settings › Capture** for area, window and full-screen screenshots, on-device text recognition, a colour picker and GIF recording — captures land straight in the shelf.
...
- [x] Screenshots, on-device OCR, colour picker and GIF recording 📸
