...
- Turn on **Settings › Focus** for a Pomodoro timer; the countdown lives in the closed notch, and distracting apps and sites can be kept out of the way while it runs.
...
- [x] Focus timer with app and site blocking 🍅
