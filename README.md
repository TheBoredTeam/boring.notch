...
- Turn on **Settings › Live Activities** to see a meeting appear in the notch just before it starts — open the notch to join it in one click.
...
- [x] Meeting live activity with one-click join 📹
