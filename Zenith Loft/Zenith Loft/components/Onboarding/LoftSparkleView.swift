...
class LoftSparkleNSView: NSView {
...
struct LoftSparkleView: NSViewRepresentable {
    func makeNSView(context: Context) -> LoftSparkleNSView {
        return LoftSparkleNSView()
    }
    
    func updateNSView(_ nsView: LoftSparkleNSView, context: Context) {}
}
