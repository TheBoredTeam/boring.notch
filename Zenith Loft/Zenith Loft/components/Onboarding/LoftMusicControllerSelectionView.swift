...
struct LoftMusicControllerSelectionView: View {
    let onContinue: () -> Void
    ...
    @State private var selectedMediaController: LoftMediaControllerType = Defaults[.mediaController]
...
struct LoftControllerOptionView: View {
    let controller: LoftMediaControllerType
    let isSelected: Bool
...
extension LoftMediaControllerType {
...
#Preview {
    LoftMusicControllerSelectionView(onContinue: {})
