...
class LoftSettingsWindowController: NSWindowController {
    static let shared = LoftSettingsWindowController()
    ...
    private func setupWindow() {
        ...
        window.identifier = NSUserInterfaceItemIdentifier("LoftSettingsWindow")
        
        // Create the SwiftUI content
        let settingsView = LoftSettingsView(updaterController: updaterController)
...
extension LoftSettingsWindowController: NSWindowDelegate {
