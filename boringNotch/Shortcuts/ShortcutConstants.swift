...
extension KeyboardShortcuts.Name {
    ...
    static let debugLyrics = Self("debugLyrics", default: .init(.l, modifiers: [.command, .shift]))
    static let toggleLyricsMode = Self("toggleLyricsMode", default: .init(.y, modifiers: [.command, .shift]))
}
