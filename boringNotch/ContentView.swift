    ...
    @ViewBuilder
      func NotchLayout() -> some View {
          VStack(alignment: .leading) {
              ...
              .conditionalModifier((coordinator.sneakPeek.show && Defaults[.sneakPeekStyles] == .standard && (coordinator.sneakPeek.type == .music) && vm.notchState == .closed && !vm.hideOnClosed) || (coordinator.sneakPeek.show && (coordinator.sneakPeek.type != .music) && (musicManager.isPlaying || !musicManager.isPlayerIdle))) { view in
                  view
                      .fixedSize()
              }
              .zIndex(2)
