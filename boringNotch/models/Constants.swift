...
extension Defaults.Keys {
    ...
    static let showWeatherIcon = Key<Bool>("showWeatherIcon", default: false)
    static let temperatureCelsius = Key<Bool>("temperatureCelsius", default: true)
    static let weatherAPIToken = Key<String>("weatherAPIToken",default: "")
