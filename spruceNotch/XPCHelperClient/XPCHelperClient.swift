...
final class XPCHelperClient: NSObject {
    ...
    private let serviceName = "theboringteam.sprucenotch.SpruceNotchXPCHelper"
    
    private var remoteService: RemoteXPCService<SpruceNotchXPCHelperProtocol>?
    ...
    @MainActor
    private func ensureRemoteService() -> RemoteXPCService<SpruceNotchXPCHelperProtocol> {
        ...
        let service = RemoteXPCService<SpruceNotchXPCHelperProtocol>(
            connection: conn,
            remoteInterface: SpruceNotchXPCHelperProtocol.self
        )
    ...
    @MainActor
    private func getRemoteService() -> RemoteXPCService<SpruceNotchXPCHelperProtocol>? {
        remoteService
    }
